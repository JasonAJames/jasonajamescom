...
if ($password_protect == "off") {
	...
	// Check crypted pass against stored pass. Check random string and pass hashed concatenate against post. Check hashed and crypted agent/language concatenate against post.
		...
		<form action=\"GreetingCards.php\" method=\"post\" name=\"form1\" onsubmit=\"return obfuscate()\">
		$p
...
$p
$UploadGreetingCardsPageTitle
$p2
<table class=\"upload\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
<tr>
<td colspan=\"6\">
<form action=\"GreetingCards.php\" method=\"post\" enctype=\"multipart/form-data\">
<div id =\"upload_popup\">
...
<form action=\"GreetingCards.php\" method=\"post\">
$p
...
echo "<script type=\"text/javascript\">
<!--
var URL   = \"GreetingCards.php?pg=$pg\"
var speed = $upload_redirect
function reload() {
location = URL
}
