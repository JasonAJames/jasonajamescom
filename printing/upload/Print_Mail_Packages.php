...
if ($password_protect == "off") {
	...
	// Check crypted pass against stored pass. Check random string and pass hashed concatenate against post. Check hashed and crypted agent/language concatenate against post.
		...
		<form action=\"Print_Mail_Packages.php\" method=\"post\" name=\"form1\" onsubmit=\"return obfuscate()\">
		$p
...
include("lang/$language");
// Name of page for links, title, and logout.
$logout = "Print_Mail_Packages.php";
$page_name = "upload";
...
$p
$UploadPrint_Mail_PackagesPageTitle
$p2
<table class=\"upload\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
<tr>
<td colspan=\"6\">
<form action=\"Print_Mail_Packages.php\" method=\"post\" enctype=\"multipart/form-data\">
<div id =\"upload_popup\">
...
<form action=\"Print_Mail_Packages.php\" method=\"post\">
$p
...
echo "<script type=\"text/javascript\">
<!--
var URL   = \"Print_Mail_Packages.php\"
...
echo "<script type=\"text/javascript\">
<!--
var URL   = \"Print_Mail_Packages.php?pg=$pg\"
var speed = $upload_redirect
function reload() {
location = URL
}
