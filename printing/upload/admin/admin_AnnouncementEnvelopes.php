...
if ($password_protect == "off") {
	...
	// Check crypted pass against stored pass. Check random string and pass hashed concatenate against post. Check hashed and crypted agent/language concatenate against post.
		...
		<form action=\"admin_AnnouncementEnvelopes.php\" method=\"post\" name=\"form1\" onsubmit=\"return obfuscate()\">
		$p
...
include("../lang/$language");
// Name of page for links, title, and logout.
$logout = "admin_AnnouncementEnvelopes.php";
$page_name = "upload";
...
<tr>
<td colspan=\"6\">
<form action=\"admin_AnnouncementEnvelopes.php\" method=\"post\" enctype=\"multipart/form-data\">
<div id =\"upload_popup\">
...
<form action=\"admin_AnnouncementEnvelopes.php\" method=\"post\">
$p
...
echo "<script type=\"text/javascript\">
<!--
var URL   = \"admin_AnnouncementEnvelopes.php\"
...
echo "<script type=\"text/javascript\">
<!--
var URL   = \"admin_AnnouncementEnvelopes.php?pg=$pg\"
var speed = $upload_redirect
function reload() {
location = URL
}
