...
if ($password_protect == "off") {
	...
	// Check crypted pass against stored pass. Check random string and pass hashed concatenate against post. Check hashed and crypted agent/language concatenate against post.
		...
		<form action=\"Flyers.php\" method=\"post\" name=\"form1\" onsubmit=\"return obfuscate()\">
		$p
...
$p
$UploadFlyersPageTitle
$p2
<table class=\"upload\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
<tr>
<td colspan=\"6\">
<form action=\"Flyers.php\" method=\"post\" enctype=\"multipart/form-data\">
<div id =\"upload_popup\">
...
<form action=\"Flyers.php\" method=\"post\">
$p
...
$upload_dir = ($_SERVER['DOCUMENT_ROOT'] . "/$fileupload_Flyers_dir_name/");
...
// Path to file.
$upload_file_path = ($_SERVER['DOCUMENT_ROOT'] . "/$fileupload_Flyers_dir_name/$file");
// Delete file
...
if (file_exists($upload_file_path)) {
	rename ($upload_file_path, $_SERVER['DOCUMENT_ROOT'] . "/$fileupload_Flyers_dir_name/$upload_newname") or die ("$l_upload19");
